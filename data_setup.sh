...
echo "\n\nCreate KB data...\n"
cd freebase_data
python convert.py SimpleQuestions/freebase-subsets/freebase-FB2M.txt
mv FB2M.core.txt dump_virtuoso_data/

# 3. load data into knowledge base
echo "\n\nload data into knowledge base...\n"
isql 1111 dba dba exec="ld_dir_all('/data/wukun/virtuoso-opensource/database/free_base', '*', 'fb2m:');"
pids=()
for i in `seq 1 4`; do
...
python process_rawdata.py ../freebase_data/SimpleQuestions/annotated_fb_data_train.txt 5
python process_rawdata.py ../freebase_data/SimpleQuestions/annotated_fb_data_valid.txt 2
python process_rawdata.py ../freebase_data/SimpleQuestions/annotated_fb_data_test.txt 5
